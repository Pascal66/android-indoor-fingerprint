package at.fhstp.wificompass.wifi.scan;
...
import at.fhstp.wificompass.activities.UserTrackerActivity;
...
import at.fhstp.wificompass.trilateration.FingerprintLocator;
import at.fhstp.wificompass.trilateration.UserPointTrilateration;
import at.fhstp.wificompass.trilateration.model.AccessPointResult;
    ...
    //receiver del wifi scan
  	public class MainWifiReceiver extends WifiReceiver {
  		...
  		public void onReceive(Context c, Intent intent) {
  			...
  			//se non è in scansione esce dal metodo
  	...
  	private void updateUserPositionByTrilateration(WifiScanResult wr, int algorithmSelection) {
  		...
  		if(wr.getBssids() != null) {
  			...
  			for (BssidResult result : wr.getBssids()) {
  				...
  				//se l'AP non è tra quelli selezionati lo salta
  				...
  				//se già esiste l'AP ricalcola il livello di segnale (in modo da attenuare il rumore)
