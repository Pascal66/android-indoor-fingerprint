...
public class ScaleSliderDrawable extends MultiTouchDrawable {
	...
	protected void forwardRelativePositionToScaleLine() {
		...
		if(superDrawable instanceof ScaleRectangleDrawable)
			((ScaleRectangleDrawable)superDrawable).onSliderMove(id);
		
		if(superDrawable instanceof ScaleCircleDrawable)
			((ScaleCircleDrawable)superDrawable).onSliderMove(id);
