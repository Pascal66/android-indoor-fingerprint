package at.fhstp.wificompass.geofences;
...
public class GeoFencesManager {
	...
	class RectangleFence {
		...
		public boolean pointIsContained(Location point) {
			...
			//se nessuna delle distanze tra punto e angolo è maggiore della diagonale -> si trova all'interno dell'area
	...
	class CircleFence {
		...
		public boolean pointIsContained(Location point) {
			//se la distanza tra il punto è il centro del cerchio è minore del raggio -> si trova all'interno dell'area
